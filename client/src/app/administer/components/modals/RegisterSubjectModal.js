...
import { registerSubject } from '@/actions/administerServerActions'

import { XMarkIcon } from '@heroicons/react/20/solid'

export default function RegisterSubjectModal({ currentUser, classroomId, registeredTeachers }) {
    ...
    const handleSubmit = (event) => {
        event.preventDefault();
        startTransition(() => registerSubject(inputs, currentUser.instituteId, currentUser.currentSession, classroomId));
        setInputs({
            subjectName: "",
            subjectCode: "",
            assignedTeacherName: "",
                                ...
                                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <form onSubmit={handleSubmit} className="h-full space-y-3 text-sm font-medium">
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            ...
                                            <div className="col-span-1">
                                                <label className="px-2">Subject's Code</label>
                                                <input
                                                    name="subjectCode"
                                                    id="newSubjectCode"
                                                    type="text"
