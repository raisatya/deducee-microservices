...
import { updateAdmin } from "@/actions/administerServerActions"

import { PencilSquareIcon, XMarkIcon } from '@heroicons/react/24/outline'

export default function UpdateAdminDataModal({ currentUser, adminDetails }) {
    ...
    const [inputs, setInputs] = useState({
        ...
        qualifications: adminDetails.qualifications,
        dateOfBirth: adminDetails.dateOfBirth,
        joinedOn: adminDetails.joinedOn,
    ...
    const handleSubmit = (event) => {
        event.preventDefault();
        startTransition(() => updateAdmin(inputs, adminDetails.id));
        setIsOpen(false);
    }
