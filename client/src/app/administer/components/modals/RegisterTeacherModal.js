...
import { registerTeacher } from "@/actions/administerServerActions"

import { PlusIcon, XMarkIcon } from '@heroicons/react/20/solid'

export default function RegisterTeacherModal({ currentUser }) {
    ...
    const handleSubmit = (event) => {
        event.preventDefault();
        startTransition(() => registerTeacher(inputs, currentUser.instituteId));
        setInputs({
            fullName: "",
            gender: "",
            designation: "",
